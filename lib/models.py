...
class Game(Base):
    ...
    users=relationship('Users', secondary=game_user,back_populates='games')
...
# #connect both game and user models
# #back_populates used in place of backref due to many to many 
